...
def train(data_name: str, data_path: str, classes_per_node: int, num_nodes: int, fraction: float,
    ...
    with open(str(save_path / f"Hetero_FedGH_N{num_nodes}_C{fraction}_R{steps}_E{epochs}_B{bs}_NonIID_{data_name}_class_{classes_per_node}.csv"), 'w', newline='') as file:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--total-classes", type=str, default=10)
    ...
    parser.add_argument("--fraction", type=int, default=1, help="number of sampled nodes in each round")
    ...
    parser.add_argument("--epochs", type=int, default=30, help="number of inner steps")
